...
class GameFixtures extends Fixture implements DependentFixtureInterface 
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $tagRPG = $this->getReference(TagFixtures::TAG_REFERENCE_RPG);
        $tagAction = $this->getReference(TagFixtures::TAG_REFERENCE_Action);
        $tagAventure = $this->getReference(TagFixtures::TAG_REFERENCE_Aventure);
        $tagCourse = $this->getReference(TagFixtures::TAG_REFERENCE_Course);
        $tagSimulation = $this->getReference(TagFixtures::TAG_REFERENCE_Simulation);
        $tagStrategie = $this->getReference(TagFixtures::TAG_REFERENCE_Strategie);
        ...
        $developer1 = $this->getReference(DeveloperFixtures::DEVELOPER_REFERENCE_1);
        $developer2 = $this->getReference(DeveloperFixtures::DEVELOPER_REFERENCE_2);
        $developer3 = $this->getReference(DeveloperFixtures::DEVELOPER_REFERENCE_3);
        $developer4 = $this->getReference(DeveloperFixtures::DEVELOPER_REFERENCE_4);
        $developer5 = $this->getReference(DeveloperFixtures::DEVELOPER_REFERENCE_5);

        $game1 = new Game();
        $game1->setName("YAKUZA: LIKE A DRAGON");
        $game1->addDeveloper($developer2);
